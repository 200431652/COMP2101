...
myargs=()
#Create variables to identify input stat
verbmode=0
debmode=0
...
while [ $# -gt 0 ]; do
  ...
  *)
  ...
  #Shifting of command line argument
  shift
...
# in order to check variable stat we apply if condition
...
if [ $debmode -gt 0 ]; then
  echo "Debug Mode is On with debug level $debmode."
else
